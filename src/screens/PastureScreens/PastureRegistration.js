      ...
      >
        ...
        <View style={Screenstyles.NRcontainer}>
          <View style={Screenstyles.NRtitle}>
            ...
            <Text style={Screenstyles.NRtitleLabel}>
              [注意] 同じポイント分、{" "}
              <Text style={Screenstyles.NRtitleLabelSpan}>維持費</Text>
              がかかります !
            </Text>
          </View>
          <View style={Screenstyles.NRpay}>
            <View style={Screenstyles.NRleft}>
              <View style={Screenstyles.NRleftD}>
                ...
                <Text style={Screenstyles.NRleftL}>
                  {(!!selected && selected.payMent) || "500"}pt
                </Text>
              </View>
                ...
                <Image
                  style={
                    !!selected && selected.id == 1
                      ? Screenstyles.NRImageSmall
                      : !!selected && selected.id == 2
                      ? Screenstyles.NRImageMiddle
                      : !!selected && selected.id == 3
                      ? Screenstyles.NRImageBig
                      : Screenstyles.NRImageSmall
                  }
                  source={require("../../assets/images/pasture.jpg")}
                />
              </View>
              <Text style={Screenstyles.NRcaution}>
                {(!!selected && selected.Caution) || "※種牡馬・施設は"}
                <Text style={Screenstyles.NRSpan}>
                  {(!!selected && selected.CautionS) || "不可"}
                </Text>
              </Text>
            ...
            <View
              style={
                !!selected && selected.id == 1
                  ? Screenstyles.NRSmallRight
                  : !!selected && selected.id == 2
                  ? Screenstyles.NRMiddleRight
                  : !!selected && selected.id == 3
                  ? Screenstyles.NRBigRight
                  : Screenstyles.NRRight
              }
            >
              <View style={Screenstyles.NRrightTxtGroup}>
                <Text style={Screenstyles.NRtxt}>0歳馬 : </Text>
                <Text style={Screenstyles.NRtxtSpan}>
                  {" "}
                  {(!!selected && selected.value) || 1}頭
                </Text>
              </View>
              <View style={Screenstyles.NRrightTxtGroup}>
              ...
              <View style={Screenstyles.NRrightTxtGroup}>
                ...
                <Text style={Screenstyles.NRtxtSpanT}>
                  {" "}
                  {(!!selected && selected.value) || 1}頭
                </Text>
              </View>
              ...
              {!!selected && (
                <View style={Screenstyles.NRrightTxtGroup}>
                  ...
                  <Text
                    style={
                      !!selected && selected.id == 2
                        ? Screenstyles.NRtxtSpanV2
                        : !!selected && selected.id == 3
                        ? Screenstyles.NRtxtSpanV
                        : Screenstyles.NRtxtSpanV
                    }
                  >
                    {selected.TypeV}
