  ...
  useEffect(() => {
    ...
    if (checkSub) {
      if (validationData.noName || validationData.noNameMean) {
        validationData.noName
          ? setDisplayName("flex")
          : setDisplayNameMean("flex");
      } else {
        ...
        <View style={Screenstyles.NRcontainer}>
          ...
          <View style={Screenstyles.PNameRegister}>
            <View style={Screenstyles.FarmName}>
              ...
              <Text style={[{ display: displayName }]} id="caution">
                ※すでにその名前は
                <Text style={Screenstyles.NRSpanT}>使用されています</Text>。
              </Text>
              <Text style={[{ display: displayNameStyle }]} id="caution">
                ※すでにその名前は
                <Text style={Screenstyles.NRSpanT}>使用されています</Text>。
              </Text>
            </View>
            <View style={Screenstyles.TName}>
              ...
              <Text style={[{ display: displayNameMean }]}>
                ※すでにその名前は
                <Text style={Screenstyles.NRSpanT}>使用されています</Text>。
              </Text>
              <Text style={[{ display: displayNameMeanStyle }]} id="caution">
                ※すでにその名前は
                <Text style={Screenstyles.NRSpanT}>使用されています</Text>。
              </Text>
            </View>
