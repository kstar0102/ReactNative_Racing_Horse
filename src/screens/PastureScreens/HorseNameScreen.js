              ...
              <View key={item.horseId} style={Screenstyles.horseNameCard}>
                <View style={Screenstyles.horseCardContent}>
                  ...
                  <View style={Screenstyles.horseCardRight}>
                    <BloodlineNameTable father_sys={item.f_sys} father_f_sys={item.f_f_sys} father_m_sys={item.f_m_sys} mother_sys={item.m_sys} mother_f_sys={item.m_f_sys} mohter_m_sys={item.m_m_sys}/>
                  </View>
                </View>
                ...
                <View style={Screenstyles.TName}>
                  ...
                  <View style={Screenstyles.TNameInput}>
                    <HorseNameInput id={item.id} onChangeText={handleInputChange} onBlurText = {handleOnBlur}/>
                  </View>
...
const mapStateToProps = state => {
  return {
    ...
    pasture_id: state.auth.pasture.id
  };
};
