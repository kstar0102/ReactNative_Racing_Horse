               ...
               <View style={RTapScreensStyle.ranchContent}>
                  <View style={RTapScreensStyle.avatarGroup}>
                      <View style={RTapScreensStyle.avatar}>
                          <AvatarButton id={5} stableId={stableMenu[3].id} horseId={horseId}  name='矢道厩舎'/>
                       </View>
                  ...
                  <View style={RTapScreensStyle.avatarGroup}>
                      <View style={RTapScreensStyle.avatar}>
                          <AvatarButton id={6} stableId={stableMenu[4].id} horseId={horseId}  name='池貝廳舍'/>
                       </View>
                       <View style={RTapScreensStyle.avatarTxt}>
                  ...
                  <View style={RTapScreensStyle.avatarGroup}>
                      <View style={RTapScreensStyle.avatar}>
                          <AvatarButton id={7} stableId={stableMenu[5].id} horseId={horseId}  name='中外田厩舎'/>
                       </View>
                       <View style={RTapScreensStyle.avatarTxt}>
