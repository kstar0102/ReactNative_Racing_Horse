        ...
        >
          ...
          <View style={RTapScreensStyle.ImageButtonTop}>
            <View>
              ...
              <ImageButton
                label={"にんじん"}
                source={require("../../../assets/images/Fodder/carrot.png")}
                id={1}
              />
              <DetailButton
                label={"調子回復"}
            ...
            <View>
              ...
              <ImageButton
                label={"Sドリンク"}
                source={require("../../../assets/images/Fodder/source.png")}
                id={0}
              />
              <DetailButton
                label={"調子回復"}
            ...
            <View>
              ...
              <ImageButton
                label={"プロテイン"}
                source={require("../../../assets/images/Fodder/protein.png")}
                id={3}
              />
              <DetailButton
                label={"調子回復"}
          ...
          <View style={RTapScreensStyle.ImageButtonMiddle}>
            <View>
              ...
              <ImageButton
                label={"角砂糖"}
                source={require("../../../assets/images/Fodder/角砂糖2.png")}
                id={4}
              />
              <DetailButton
                label={"疲労回復"}
            ...
            <View>
              ...
              <ImageButton
                label={"チョコ"}
                source={require("../../../assets/images/Fodder/チョコ.png")}
                id={5}
              />
              <DetailButton
                label={"疲労回復"}
            ...
            <View>
              ...
              <ImageButton
                label={"ケーキ"}
                source={require("../../../assets/images/Fodder/ケーキ.png")}
                id={6}
              />
              <DetailButton
                label={"疲労回復"}
