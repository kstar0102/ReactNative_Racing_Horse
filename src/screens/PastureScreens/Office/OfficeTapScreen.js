  ...
  return (
    <View style={styles.container}>
      <View style={styles.buttons}>
        <ITapButton id={3} color={3} isActive={activeButton === 3} label={'戦績'} onPress={handleButtonPress} />
        <ITapButton id={2} color={2} isActive={activeButton === 2} label={'騎手'} onPress={handleButtonPress} />
        <ITapButton id={1} color={1} isActive={activeButton === 1} label={'競走馬'} onPress={handleButtonPress} />
        <ITapButton id={4} color={4} isActive={activeButton === 4} label={'繁殖馬'} onPress={handleButtonPress} />
        <ITapButton id={5} color={5} isActive={activeButton === 5} label={'種牡馬'} onPress={handleButtonPress} />
      </View>
