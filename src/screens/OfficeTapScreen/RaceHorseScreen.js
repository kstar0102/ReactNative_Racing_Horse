...
const RaceHorseScreen = () => {
  const CONTENT = {
    tableHeadTitle: ['順位', '馬名', ' ', '通算成績', '獲得賞金(Pt)'],
    ...
    tableData: [
      ['4位','アレックス', '牡馬', '70-70-70-70', '150,000,000'],
      ['5位','田中太郎', '牝馬', '60-60-60-60', '100,000,000'],
      ['6位', '王　金銀', '牡馬', '50-50-50-50', '80,000,000'],
      ['7位', 'マイケル', '牝馬', '40-40-40-40', '60,000,000'],
      ['8位', 'メイプル', '牡馬', '30-30-30-30', '40,000,000'],
...
export default RaceHorseScreen;
