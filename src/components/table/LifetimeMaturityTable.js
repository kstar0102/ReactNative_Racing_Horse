      ...
      <View style={styles.content}>
        <View style={styles.lifetimeMaturity}>
          <View style={styles.lifetimeMaturityName}>
            <Text style={styles.lifetimeMaturityTxt}>通 算 成 績</Text>
          </View>
          <View style={styles.lifetimeMaturityValue}>
            <Text style={styles.lifetimeMaturityNumber}>100-100-100-100</Text>
          </View>
        </View>
        {/* hidden GI */}
        {/* Overseas GI */}
        ...
        <View style={styles.bodyContent}>
          <View style={styles.oneColumn}>
            <View style={styles.hidden}>
              <Text style={[styles.txt, styles.hiddenTxtDotes]}>隠しGI</Text>
            </View>
            <View style={styles.hiddenWin}>
              <Text style={[styles.txt]}>100勝</Text>
            </View>
            <View style={styles.hiddenWinRate}>
              <Text
                style={[styles.txt, styles.hiddenTxtDotes, styles.hiddenColor]}
              >
                勝率
              </Text>
            </View>
            <View style={styles.hiddenPercent}>
              <Text style={[styles.txt, styles.hiddenTxt]}>50%</Text>
            </View>
          </View>
          {/*  */}
            ...
            <View style={styles.overseasContent}>
              <View style={styles.overseasGrass}>
                <Text
                  style={[
                    styles.txt,
                    styles.overseasTxtDotes,
                    styles.overseasColor,
                  ]}
                >
                  芝
                </Text>
          ...
          <View style={styles.threeColumn}>
            <View style={styles.domestic}>
              <Text style={[styles.txt, styles.domesticTxtDotes]}>国内GI</Text>
            </View>
            ...
            <View style={styles.domesticDirt}>
              <Text
                style={[
                  styles.txt,
                  styles.domesticTxtDotes,
                  styles.domesticColor,
                ]}
              >
                ダート
              </Text>
        ...
        <View style={styles.lifetimeMaturity}>
          <View style={styles.lifetimeMaturityName}>
            <Text style={styles.lifetimeMaturityTxt}>獲 得 賞 金</Text>
          </View>
          <View style={styles.lifetimeMaturityValue}>
            <Text style={styles.lifetimeMaturityNumber}>300,000,000</Text>
          </View>
        </View>
      </View>
    </View>
