  ...
  return (
    <>
      <ModalStack.Navigator>
        ...
        />
        <ModalStack.Screen
          name={"PastureRegistration"}
          component={PastureRegistration}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"HorseChoiceScreen"}
          component={HorseChoiceScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"UpbringingScreen"}
          component={UpbringingScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"PastureNameScreen"}
          component={PastureNameScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"HorseNameScreen"}
          component={HorseNameScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
        ...
        />
        <ModalStack.Screen
          name={"RacetrackScreen"}
          component={RacetrackScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"WorkingHorseScreen"}
          component={WorkingHorseScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
        ...
        />
        <ModalStack.Screen
          name={"RaceRegistation"}
          component={RaceRegistation}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"RaceResults"}
        ...
        <ModalStack.Screen
          name={"JockeyTraingin"}
          component={JockeyTraingin}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"JocTraining"}
          component={JocTraining}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"RaceCourse"}
        ...
        />
        <ModalStack.Screen
          name={"TrainingReservationScreen"}
          component={TrainingReservationScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"JockeyReservationScreen"}
          component={JockeyReservationScreen}
          options={horizontalAnimation}
        />
        {/* RaceCourse */}
        <ModalStack.Screen
          name={"RaceCourseScreen"}
        ...
        />
        <ModalStack.Screen
          name={"StableRaceCourse"}
          component={StableRaceCourse}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"PastureRaceCourseScreen"}
          component={PastureRaceCourseScreen}
          options={horizontalAnimation}
        />
        <ModalStack.Screen
          name={"HorseRace"}
